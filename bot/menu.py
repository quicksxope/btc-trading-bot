...
def help_message_html() -> str:
    return (
        ...
        "<b>Strategi</b>\n"
        "Preset: Cipher_B, EMA, RSI. Custom = guided indicators + DSL rules "
        "(templates / long_when / short_when).\n\n"
        "<b>Wizard urutan</b>\n"
        "Aset → TF → indikator/strategi → jam trading → R:R → prop (mapping atau custom).\n"
        "Periode default 6 bulan (ubah di Review). Prop custom: max loss %, profit, consistency.\n\n"
        "<b>Data</b>\n"
